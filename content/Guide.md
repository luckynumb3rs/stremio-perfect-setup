...
2. Choose a Debrid service for caching the torrents, create an account on it, buy a subscription, and get the API key.
   ...
   * *I use mainly* [***TorBox***](https://torbox.app/subscription?referral=4a434cdb-8d5f-4634-9115-8ebf4cea4133), as a backup I use [***Real-Debrid***](http://real-debrid.com/?id=12639093) *(these are referral links since we're at it :), two of the best platforms, with the best prices and very stable.*
