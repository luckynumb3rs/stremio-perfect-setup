...
>**📢 NOTES:**
>* If you are a **total beginner** and are curious to **understand the concepts around Stremio/Nuvio** and how it works, go to [**🔰 Beginner Concepts**]({{GUIDE_PATH}}/0-Beginner-Concepts.md).
