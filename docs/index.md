...
> 
> See [Updates](docs/Updates.md) for detailed instructions.
...
**NOTES**:
* *If you are a total beginner and are curious to understand more how Stremio ecosystem works and the concepts around it, go to **Beginner Concepts**.*
* *If you already followed this guide and are encountering issues or have configuration questions, go to **Configuration Q&A**. If you're just starting, remember this for later in case you need it.*
...
* [**Beginner Concepts**](docs/0-Beginner-Concepts.md)

1. [Accounts Preparation](docs/1-Accounts-Preparation.md)
2. [Stremio Account Initialization](docs/2-Stremio-Initialization.md)
3. [AIOStreams Setup](docs/3-AIOStreams-Setup.md)
4. [AIOMetadata Setup](docs/4-AIOMetadata-Setup.md)
5. [Cinebye Cleanup](docs/5-Cinebye-Cleanup.md)
6. [Personalized Lists](docs/6-Personalized-Lists.md)

* [**Additional Stuff**](docs/7-Additional-Stuff.md)

* [**Configuration Q&A**](docs/8-Configuration-QA.md)
