...
>**NOTES:**
>* **✨ NEW:** If you want to use this setup with **Nuvio** instead of Stremio, or you want a good **Nuvio Collections** setup, including dynamic backdrops, title logos, and assets, check out the new [**🚀 Nuvio**](guide/Nuvio.md) page.
