...
* **Activity Visibility**: Access optional usage insights and monitoring tools for better oversight.
...
2. Go to the **Settings** tab and copy the **UUID** shown there and store it together with the **Password** you set.
...
6. Click on "**View Addons**" on the account you added.
...
* While inside an account, you can click on "**Bulk Actions**" and:
   ...
   * **Reorder Addons**: Change the order of the addons (*just like with Cinebye*).
   ...
   * **Install From Library**: Install addons saved in the aforementioned library.
...
4. Click on "**Bulk Actions**" and then "**Reorder Addons**".
