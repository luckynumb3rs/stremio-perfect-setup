...
read -r -d '' PARAMETERS <<'JSON' || true
{
  ...
  "FEATURED_TEMPLATE_IDS": "stremio.perfect.setup,stremio.perfect.setup.formatter",
  "SEL_SYNC_ACCESS":"trusted",
  "TEMPLATE_URLS": "[\"https://numb3rs.stream/templates/AIOStreams.json\", \"https://numb3rs.stream/templates/AIOStreams-Formatter.json\", \"https://raw.githubusercontent.com/Tam-Taro/SEL-Filtering-and-Sorting/refs/heads/main/Tamtaro-All-Templates-for-AIOStreams.json\", \"https://raw.githubusercontent.com/Vidhin05/Releases-Regex/refs/heads/main/all-templates.json\"]",
