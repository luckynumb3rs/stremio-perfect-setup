...
read -r -d '' PARAMETERS <<'JSON' || true
{
  ...
  "CUSTOM_HTML":"<div class=\"UI-Card__content p-4 pt-4 space-y-3 flex-wrap\"><div class=\"[&_a]:text-[--brand] [&_a:hover]:underline\"><div style=\"background:transparent;color:#fff;padding:24px 28px;margin:0;width:100%;max-width:none;position:relative;overflow:hidden;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;display:flex;align-items:center;justify-content:space-between;gap:28px;text-align:center;\"><div style=\"font-size:116px;line-height:1;flex:0 0 auto;text-shadow:0 0 30px rgba(124,92,255,0.45);animation:crystalMagic 7.5s ease-in-out infinite;transform-origin:center;\">🔮</div><div style=\"min-width:0;flex:1 1 auto;text-align:center;\"><h2 style=\"margin:0 0 9px 0;font-size:1.8em;font-weight:700;line-height:1.2;\"><span style=\"color:#ffffff;\">Quick Automated</span> <span style=\"color:#9b7cff;text-shadow:0 0 20px rgba(124,92,255,0.18);\">Stremio/Nuvio</span> <span style=\"color:#ffffff;\">Perfect Setup</span></h2><p style=\"margin:0 0 8px 0;font-size:1.12em;line-height:1.45;opacity:0.94;font-weight:400;\">Skip the manual work and let the wizard configure your setup in seconds.</p><p style=\"margin:0 0 10px 0;font-size:0.98em;line-height:1.45;opacity:0.9;font-weight:400;\"><span style=\"color:#c7b8ff;font-weight:700;\">Fast guided flow</span> for apps, addons, providers, and settings. <span style=\"color:#d8ccff;font-weight:700;\">Less copy-paste</span>, fewer mistakes, and a cleaner setup from the start.</p><a href=\"https://ko-fi.com/luckynumb3rs\" target=\"_blank\" style=\"font-size:0.95em;color:#ccc;text-decoration:none;opacity:0.8;transition:opacity 0.2s ease;\">☕ Donate via Ko-fi</a></div><a href=\"https://numb3rs.stream/\" onmouseover=\"this.style.background='rgba(155,124,255,0.18)';this.style.borderColor='#b89cff';this.style.color='#d8ccff';this.style.transform='translateY(-2px) scale(1.025)';\" onmouseout=\"this.style.background='rgba(124,92,255,0.08)';this.style.borderColor='#9b7cff';this.style.color='#a986ff';this.style.transform='translateY(0) scale(1)';\" style=\"display:inline-flex;align-items:center;justify-content:center;gap:12px;flex:0 0 auto;background:rgba(124,92,255,0.08);color:#a986ff;padding:18px 34px;border-radius:18px;font-size:1.25em;font-weight:800;line-height:1;text-decoration:none;box-shadow:none;transition:background 0.22s ease,border-color 0.22s ease,color 0.22s ease,transform 0.22s ease;animation:wizardButtonPulse 3.8s ease-in-out infinite;border:2px solid #9b7cff;white-space:nowrap;cursor:pointer;\"><svg width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2.3\" stroke-linecap=\"round\" stroke-linejoin=\"round\" aria-hidden=\"true\" style=\"display:block;flex:0 0 auto;\"><path d=\"M15 4V2\"></path><path d=\"M15 10V8\"></path><path d=\"M19 6h2\"></path><path d=\"M9 6H7\"></path><path d=\"m18 3 1 1\"></path><path d=\"m11 10 1 1\"></path><path d=\"m18 9 1-1\"></path><path d=\"m11 2 1 1\"></path><path d=\"m14 7-9 9 2 2 9-9-2-2Z\"></path></svg><span>Launch Wizard</span></a><style>@keyframes crystalMagic{0%,100%{transform:translateY(0) rotate(0deg) scale(1);filter:brightness(1)}20%{transform:translateY(-10px) rotate(-5deg) scale(1.06);filter:brightness(1.16)}45%{transform:translateY(4px) rotate(4deg) scale(0.98);filter:brightness(1)}65%{transform:translateY(-7px) rotate(5deg) scale(1.08);filter:brightness(1.2)}82%{transform:translateY(2px) rotate(-3deg) scale(1.02);filter:brightness(1.08)}}@keyframes wizardButtonPulse{0%,100%{box-shadow:0 0 0 rgba(155,124,255,0);filter:brightness(1)}50%{box-shadow:0 0 16px rgba(155,124,255,0.18);filter:brightness(1.08)}}</style></div></div></div>"
}
JSON
