...
select_modules_interactively() {
  ...
  raw_input="$(prompt_value "Enter optional modules by name or number, separated by commas" "$(join_by ',' "${default_selected_optional[@]}")")"
...
select_modules_with_whiptail() {
  ...
  prompt_text="Use Up/Down to move, Space to toggle, and Enter to confirm.\nRequired modules are always enabled: ${required_label}"
