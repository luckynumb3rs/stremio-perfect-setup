...
- **BIG UPDATE**: Restructured **Catalogs** by replacing *Trakt* catalogs with configurable built-in *TMDB Discover* catalogs, and added a lot more pre-configured catalogs to choose from, incl. a better categorized structure. Make sure to update the *AIOMetadata* configuration too.
